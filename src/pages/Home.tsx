          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {activeHighlights.map((h) => (
              <motion.div 
                key={h.id}
                whileHover={{ y: -4 }}
                className="group cursor-pointer bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm transition-all hover:shadow-md hover:border-slate-200"
              ...
              >
                <div className="relative h-56">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/90 backdrop-blur-md text-[#0B1220] text-[9px] font-black px-2 py-1 rounded uppercase tracking-wider border border-slate-200">
                      {h.tag}
                    </span>
                  </div>
                  {h.readTimeLabel && (
                    <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-sm px-2 py-1 rounded text-[9px] font-bold text-white uppercase tracking-tighter">
                      {h.readTimeLabel}
                    </div>
                  )}
                </div>
